...
* @returns {WasmOutput}
*/
export function run_compiler(source) {
    const ptr0 = passStringToWasm0(source, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.run_compiler(ptr0, len0);
    return WasmOutput.__wrap(ret);
}
...
export class WasmOutput {
    ...
    free() {
        ...
        wasm.__wbg_wasmoutput_free(ptr);
    }
    /**
    ...
    */
    get js() {
        try {
            ...
            wasm.wasmoutput_js(retptr, this.ptr);
    ...
    */
    get ast() {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            wasm.wasmoutput_ast(retptr, this.ptr);
            var r0 = getInt32Memory0()[retptr / 4 + 0];
            var r1 = getInt32Memory0()[retptr / 4 + 1];
            let v0;
            if (r0 !== 0) {
    ...
    */
    get errors() {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            wasm.wasmoutput_errors(retptr, this.ptr);
            var r0 = getInt32Memory0()[retptr / 4 + 0];
            var r1 = getInt32Memory0()[retptr / 4 + 1];
